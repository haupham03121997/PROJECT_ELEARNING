...
import { TwitterOutlined,FacebookOutlined  ,InstagramOutlined ,DribbbleOutlined  ,GoogleOutlined} from '@ant-design/icons';
// import styles from './styles.module.scss'
import FooterSign from "../../component/FooterSignIn"
        ...
        <div className="container">
          <div className="footer-bottom__nav">
            ...
            <div className="col-6 text-right">
              ...
              <TwitterOutlined  style={{ color : "#969696" , marginRight:"10px"}}/>
              <FacebookOutlined  style={{ color : "#969696" , marginRight:"10px"}} />
              <InstagramOutlined   style={{ color : "#969696" , marginRight:"10px"}}/>
              <DribbbleOutlined  style={{ color : "#969696" , marginRight:"10px"}} />
              <GoogleOutlined   style={{ color : "#969696" , marginRight:"10px"}}/>
